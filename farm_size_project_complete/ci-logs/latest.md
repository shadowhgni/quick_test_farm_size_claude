# CI Run Log
Run: 23150085797  Commit: fdd9712cdb5b398f00bd34b595a2d777497b7d05  Time: Mon Mar 16 15:16:20 UTC 2026
...
======================================================================
Started: 2026-03-16 14:58:45.288041
...
[01.1_chirps_download.R] 
[01.1_chirps_download.R] Finished: 2026-03-16 14:58:54.243023
[01.1_chirps_download.R] ======================================================================
...
[01.3_chirps_trends.R] CI: No CHIRPS tifs found — skipping 01.3
  ✓ PASS  01.3_chirps_trends.R                           (  3.9s)  
...
[03.2_correlation_drivers.R] Execution halted
  ✗ FAIL  03.2_correlation_drivers.R                     ( 29.8s)  Exit code: 1
...
[04.2_RF_within_country.R] Time difference of 41.97608 secs
[04.2_RF_within_country.R] Error: object 'results_Benin' not found
[04.2_RF_within_country.R] Execution halted
  ✗ FAIL  04.2_RF_within_country.R                       ( 45.7s)  Exit code: 1
...
[04.3_RF_between_countries.R] data frame with 0 columns and 0 rows
[04.3_RF_between_countries.R] Time difference of 1.173209 secs
...
[04.4_RF_model_evaluation.R]   rf2_oob_rsq rf2_test_rsq rf4_test_rsq cor_tps2_rf4 cor_rf2_rf4
[04.4_RF_model_evaluation.R] 1        0.01         0.29         0.01            0           0
...
[04.6_discrepancy_analysis.R] pdf 
[04.6_discrepancy_analysis.R]   2 
  ✓ PASS  04.6_discrepancy_analysis.R                    ( 14.6s)  
Warning message:
In system2("Rscript", c("--vanilla", shQuote(tmp)), stdout = log_file,  :
  command ''Rscript' --vanilla '/tmp/RtmpeJZ6Q9/file19d61869318d.R' > '/tmp/RtmpeJZ6Q9/file19d63f0c15c.log' 2>&1' timed out after 600s
----------------------------------------------------------------------
...
[06.4_cropland_sensitivity.R]  1st Qu.:1.7436  
[06.4_cropland_sensitivity.R]  Median :2.3256  
[06.4_cropland_sensitivity.R]  Mean   :2.2766  
[06.4_cropland_sensitivity.R]  3rd Qu.:2.6850  
...
[06.4_cropland_sensitivity.R] Removed 3669 rows containing non-finite outside the scale range
...
[06.4_cropland_sensitivity.R]   GDAL Message 1: /tmp/RtmpEFmwlU/spat_11ea773f144f5_73383_Py3ptIw2UFUXKtt.tif: Metadata exceeding 32000 bytes cannot be written into GeoTIFF. Transferred to PAM instead.
[06.4_cropland_sensitivity.R] Warning message:
[06.4_cropland_sensitivity.R] In e1@pntr$arith_rast(e2@pntr, oper, FALSE, opt) :
[06.4_cropland_sensitivity.R]   GDAL Message 1: /tmp/RtmpEFmwlU/spat_11ea72f26dfd9_73383_8UwxxeZk3QEYL3o.tif: Metadata exceeding 32000 bytes cannot be written into GeoTIFF. Transferred to PAM instead.
[06.4_cropland_sensitivity.R] pdf 
[06.4_cropland_sensitivity.R]   2 
[06.4_cropland_sensitivity.R] pdf 
[06.4_cropland_sensitivity.R]   2 
...
[08.3_farm_size_classes.R] Ncells 1780224 95.1    2846530 152.1  2846530 152.1
[08.3_farm_size_classes.R] Vcells 2494331 19.1    8388608  64.0  4243639  32.4
...
[F03_main_figure3.R] Execution halted
  ✗ FAIL  F03_main_figure3.R                             (  9.2s)  Exit code: 1
...
[S02_cropland_uncertainty.R] Execution halted
  ✗ FAIL  S02_cropland_uncertainty.R                     ( 15.3s)  Exit code: 1
...
[S03_aggregate_vs_disaggregate.R] Execution halted
  ✗ FAIL  S03_aggregate_vs_disaggregate.R                ( 29.8s)  Exit code: 1
...
[S08_variable_importance.R] Execution halted
  ✗ FAIL  S08_variable_importance.R                      ( 12.5s)  Exit code: 1
...
[T02_heterogeneity_drivers.R] Ncells 1792524 95.8    2846530 152.1  2846530 152.1
[T02_heterogeneity_drivers.R] Vcells 2634879 20.2    8388608  64.0  4243639  32.4
[T02_heterogeneity_drivers.R]           used (Mb) gc trigger  (Mb) max used  (Mb)
[T02_heterogeneity_drivers.R] Ncells 1804433 96.4    2846530 152.1  2846530 152.1
[T02_heterogeneity_drivers.R] Vcells 2670818 20.4    8388608  64.0  4243639  32.4
[T02_heterogeneity_drivers.R]           used (Mb) gc trigger  (Mb) max used  (Mb)
[T02_heterogeneity_drivers.R] Ncells 1823924 97.5    2846530 152.1  2846530 152.1
[T02_heterogeneity_drivers.R] Vcells 2726657 20.9    8388608  64.0  4243639  32.4
...
======================================================================
  ...
  ✗ FAIL  03.2_correlation_drivers.R                       29.8    Exit code: 1
  ✓ PASS  03.3_descriptive_stats.R                         18.6    
  ✓ PASS  04.1_comparing_ML_algorithms.R                    1.3    
  ✗ FAIL  04.2_RF_within_country.R                         45.7    Exit code: 1
  ...
  ✗ FAIL  F03_main_figure3.R                                9.2    Exit code: 1
  ✓ PASS  S01_drivers.R                                     1.2    
  ✗ FAIL  S02_cropland_uncertainty.R                       15.3    Exit code: 1
  ✗ FAIL  S03_aggregate_vs_disaggregate.R                  29.8    Exit code: 1
  ...
  ✗ FAIL  S08_variable_importance.R                        12.5    Exit code: 1
  ✓ PASS  T01_area_production_tables.R                      5.0    
  ✗ FAIL  T02_heterogeneity_drivers.R                       5.0    Exit code: 1

======================================================================
Total: 45   Passed: 27   Failed: 18   Time: 1055s
...
| 01.3 | `01.3_chirps_trends.R` | ✅ PASS | 3.9s |  |
...
| 03.2 | `03.2_correlation_drivers.R` | ❌ FAIL | 29.8s | Exit code: 1 |
| 03.3 | `03.3_descriptive_stats.R` | ✅ PASS | 18.6s |  |
| 04.1 | `04.1_comparing_ML_algorithms.R` | ✅ PASS | 1.3s |  |
| 04.2 | `04.2_RF_within_country.R` | ❌ FAIL | 45.7s | Exit code: 1 |
...
| F03 | `F03_main_figure3.R` | ❌ FAIL | 9.2s | Exit code: 1 |
| S01 | `S01_drivers.R` | ✅ PASS | 1.2s |  |
| S02 | `S02_cropland_uncertainty.R` | ❌ FAIL | 15.3s | Exit code: 1 |
| S03 | `S03_aggregate_vs_disaggregate.R` | ❌ FAIL | 29.8s | Exit code: 1 |
...
| S08 | `S08_variable_importance.R` | ❌ FAIL | 12.5s | Exit code: 1 |
