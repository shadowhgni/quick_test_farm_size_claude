# CI Run Log
Run: 23194304045  Commit: d7d1b8f1f4a91e07f8955bf6cac0d5f0e6b39f31  Time: Tue Mar 17 12:48:18 UTC 2026
...
======================================================================
Started: 2026-03-17 12:41:17.822285
...
[00_synthetic_data.R]   Output stubs:      5
[00_synthetic_data.R]   Processed files:   139
  ✓ PASS  00_synthetic_data                              (  7.7s)  
----------------------------------------------------------------------
...
[01.1_chirps_download.R]   Output tables:  2
[01.1_chirps_download.R] 
...
[01.1_chirps_download.R] 
[01.1_chirps_download.R] Finished: 2026-03-17 12:41:27.571016
[01.1_chirps_download.R] ======================================================================
...
[03.2_correlation_drivers.R] Final dataset: 3206 farms with complete predictor data
  ✓ PASS  03.2_correlation_drivers.R                     ( 60.7s)  
...
[04.2_RF_within_country.R] Time difference of 43.31393 secs
  ✓ PASS  04.2_RF_within_country.R                       ( 47.1s)  
...
[04.3_RF_between_countries.R] Time difference of 1.074672 mins
...
[04.3_RF_between_countries.R] (`geom_bar()`). 
  ✓ PASS  04.3_RF_between_countries.R                    ( 68.8s)  
...
[04.6_discrepancy_analysis.R] Error in `filter()`:
[04.6_discrepancy_analysis.R] ℹ In argument: `means == "TRUE"`.
[04.6_discrepancy_analysis.R] Caused by error:
[04.6_discrepancy_analysis.R] ! object 'means' not found
...
[04.6_discrepancy_analysis.R]   7. ├─dplyr::group_by(...)
[04.6_discrepancy_analysis.R]   8. ├─dplyr::select(...)
[04.6_discrepancy_analysis.R]   9. ├─dplyr::filter(...)
[04.6_discrepancy_analysis.R]  10. ├─dplyr:::filter.data.frame(...)
[04.6_discrepancy_analysis.R]  11. │ └─dplyr:::filter_impl(...)
[04.6_discrepancy_analysis.R]  12. │   └─dplyr:::filter_rows(...)
[04.6_discrepancy_analysis.R]  13. │     └─dplyr:::filter_eval(...)
[04.6_discrepancy_analysis.R]  14. │       ├─base::withCallingHandlers(...)
[04.6_discrepancy_analysis.R]  15. │       └─mask$eval_all_filter(dots_expanded, invert, env_filter)
[04.6_discrepancy_analysis.R]  16. │         └─dplyr (local) eval()
[04.6_discrepancy_analysis.R]  17. └─base::.handleSimpleError(...)
[04.6_discrepancy_analysis.R]  18.   └─dplyr (local) h(simpleError(msg, call))
[04.6_discrepancy_analysis.R]  19.     └─rlang::abort(message, class = error_class, parent = parent, call = error_call)
...
[06.4_cropland_sensitivity.R]  Median :2.1039  
[06.4_cropland_sensitivity.R]  Mean   :2.1084  
[06.4_cropland_sensitivity.R]  3rd Qu.:2.6055  
...
[06.4_cropland_sensitivity.R]   GDAL Message 1: /tmp/RtmpLXZHl9/spat_6d7962942e51_28025_Py3ptIw2UFUXKtt.tif: Metadata exceeding 32000 bytes cannot be written into GeoTIFF. Transferred to PAM instead.
[06.4_cropland_sensitivity.R] Warning message:
[06.4_cropland_sensitivity.R] In e1@pntr$arith_rast(e2@pntr, oper, FALSE, opt) :
[06.4_cropland_sensitivity.R]   GDAL Message 1: /tmp/RtmpLXZHl9/spat_6d792bc470ea_28025_8UwxxeZk3QEYL3o.tif: Metadata exceeding 32000 bytes cannot be written into GeoTIFF. Transferred to PAM instead.
[06.4_cropland_sensitivity.R] pdf 
[06.4_cropland_sensitivity.R]   2 
[06.4_cropland_sensitivity.R] pdf 
[06.4_cropland_sensitivity.R]   2 
...
[08.2_generate_virtual_farms.R] [1] 0.8633414
...
[08.3_farm_size_classes.R] Execution halted
  ✗ FAIL  08.3_farm_size_classes.R                       (  4.4s)  Exit code: 1
...
[10.1_prepare_validation_data.R] Removed 99 rows containing missing values or values outside the scale range
[10.1_prepare_validation_data.R] (`geom_line()`). 
[10.1_prepare_validation_data.R] Warning message:
[10.1_prepare_validation_data.R] Removed 99 rows containing missing values or values outside the scale range
[10.1_prepare_validation_data.R] (`geom_line()`). 
...
[10.1_prepare_validation_data.R] pdf 
[10.1_prepare_validation_data.R]   2 
  ✓ PASS  10.1_prepare_validation_data.R                 ( 16.7s)  
...
[F02_main_figure2.R] Ncells 1787764 95.5    2820218 150.7  2820218 150.7
[F02_main_figure2.R] Vcells 2519346 19.3    8388608  64.0  4313055  33.0
...
[F03_main_figure3.R] Ncells 1787767 95.5    2820218 150.7  2820218 150.7
...
[S02_cropland_uncertainty.R] Ncells 1787779 95.5    2820195 150.7  2820195 150.7
[S02_cropland_uncertainty.R] Vcells 2519260 19.3    8388608  64.0  4312903  33.0
...
[S03_aggregate_vs_disaggregate.R] Ncells 1788422 95.6    2820198 150.7  2820198 150.7
...
[S03_aggregate_vs_disaggregate.R] Joining with `by = join_by(source)`
  ✓ PASS  S03_aggregate_vs_disaggregate.R                ( 32.7s)  
...
[S04_RF_hyperparameters.R] Ncells 1788422 95.6    2820221 150.7  2820221 150.7
...
[S04_RF_hyperparameters.R]           1 
  ✓ PASS  S04_RF_hyperparameters.R                       (  7.6s)  
...
[S06_size_class_comparison.R] Ncells 1788422 95.6    2820224 150.7  2820224 150.7
[S06_size_class_comparison.R] Vcells 2520347 19.3    8388608  64.0  4313057  33.0
...
[S06_size_class_comparison.R] Joining with `by = join_by(test_country, test_GID_0)`
  ✓ PASS  S06_size_class_comparison.R                    (  4.9s)  
...
[S07_distribution_parameters.R] Ncells 1788422 95.6    2820221 150.7  2820221 150.7
[S07_distribution_parameters.R] Vcells 2520347 19.3    8388608  64.0  4313055  33.0
...
[S07_distribution_parameters.R] 2: `position_dodge()` requires non-overlapping x intervals. 
  ✓ PASS  S07_distribution_parameters.R                  (  5.2s)  
...
[S08_variable_importance.R] Ncells 1787782 95.5    2820267 150.7  2820267 150.7
[S08_variable_importance.R] Vcells 2519261 19.3    8388608  64.0  4312929  33.0
...
[S08_variable_importance.R] Size: 7 by 10 inches (150 dpi)
  ✓ PASS  S08_variable_importance.R                      (  8.3s)  
...
[T02_heterogeneity_drivers.R] Ncells 1794591 95.9    2846881 152.1  2846881 152.1
[T02_heterogeneity_drivers.R] Vcells 2632749 20.1    8388608  64.0  4244794  32.4
[T02_heterogeneity_drivers.R]           used (Mb) gc trigger  (Mb) max used  (Mb)
[T02_heterogeneity_drivers.R] Ncells 1806500 96.5    2846881 152.1  2846881 152.1
[T02_heterogeneity_drivers.R] Vcells 2668688 20.4    8388608  64.0  4244794  32.4
[T02_heterogeneity_drivers.R]           used (Mb) gc trigger  (Mb) max used  (Mb)
[T02_heterogeneity_drivers.R] Ncells 1826121 97.6    2846881 152.1  2846881 152.1
[T02_heterogeneity_drivers.R] Vcells 2724815 20.8    8388608  64.0  4244794  32.4
...
======================================================================
  ...
  ✓ PASS  03.2_correlation_drivers.R                       60.7    
  ✓ PASS  03.3_descriptive_stats.R                         17.8    
  ✓ PASS  04.1_comparing_ML_algorithms.R                    1.3    
  ✓ PASS  04.2_RF_within_country.R                         47.1    
  ✓ PASS  04.3_RF_between_countries.R                      68.8    
...
**Generated:** 2026-03-17 12:48:17 UTC
...
|-------|--------|--------|------|------|
| 00 | `00_synthetic_data` | ✅ PASS | 7.7s |  |
...
| 03.2 | `03.2_correlation_drivers.R` | ✅ PASS | 60.7s |  |
| 03.3 | `03.3_descriptive_stats.R` | ✅ PASS | 17.8s |  |
| 04.1 | `04.1_comparing_ML_algorithms.R` | ✅ PASS | 1.3s |  |
| 04.2 | `04.2_RF_within_country.R` | ✅ PASS | 47.1s |  |
| 04.3 | `04.3_RF_between_countries.R` | ✅ PASS | 68.8s |  |
