# CI Run Log
Run: 23170969906  Commit: 6e992494b9e62b0bd8e20e548d40e2ad5c76e126  Time: Mon Mar 16 23:41:22 UTC 2026
...
======================================================================
Started: 2026-03-16 23:36:25.297714
...
[01.1_chirps_download.R] 
[01.1_chirps_download.R] Finished: 2026-03-16 23:36:34.535473
[01.1_chirps_download.R] ======================================================================
...
[01.3_chirps_trends.R] CI: No CHIRPS tifs found — skipping 01.3
  ✓ PASS  01.3_chirps_trends.R                           (  3.4s)  
...
[03.2_correlation_drivers.R] Execution halted
  ✗ FAIL  03.2_correlation_drivers.R                     ( 22.2s)  Exit code: 1
...
[03.3_descriptive_stats.R] === Analysis Complete ===
  ✓ PASS  03.3_descriptive_stats.R                       ( 18.2s)  
----------------------------------------------------------------------
...
[04.2_RF_within_country.R] Time difference of 38.34112 secs
  ✓ PASS  04.2_RF_within_country.R                       ( 41.9s)  
...
[04.3_RF_between_countries.R] data frame with 0 columns and 0 rows
[04.3_RF_between_countries.R] Time difference of 1.099674 secs
[04.3_RF_between_countries.R] CI: mult_rsq empty or missing columns — skipping plot
  ✓ PASS  04.3_RF_between_countries.R                    (  4.7s)  
...
[04.6_discrepancy_analysis.R]  1 pop                     4.75
[04.6_discrepancy_analysis.R]  2 sand                    4.94
[04.6_discrepancy_analysis.R]  3 cattle                  5.44
[04.6_discrepancy_analysis.R]  4 cropland                5.44
[04.6_discrepancy_analysis.R]  5 temperature             5.56
[04.6_discrepancy_analysis.R]  6 slope                   5.62
[04.6_discrepancy_analysis.R]  7 cropland_per_capita     5.81
[04.6_discrepancy_analysis.R]  8 rainfall                5.81
[04.6_discrepancy_analysis.R]  9 maizeyield              6   
[04.6_discrepancy_analysis.R] 10 market                  6   
[04.6_discrepancy_analysis.R] Saving 5.91 x 2.95 in image
[04.6_discrepancy_analysis.R] pdf 
[04.6_discrepancy_analysis.R]   2 
  ✓ PASS  04.6_discrepancy_analysis.R                    ( 13.0s)  
----------------------------------------------------------------------
...
[05.1_RF_optimization.R] `geom_smooth()` using formula = 'y ~ x'
[05.1_RF_optimization.R] `geom_smooth()` using formula = 'y ~ x'
  ✓ PASS  05.1_RF_optimization.R                         (  3.3s)  
...
[06.3_prediction_maps.R] 06.3_prediction_maps.R complete.
  ✓ PASS  06.3_prediction_maps.R                         (  5.0s)  
...
[06.4_cropland_sensitivity.R]  1st Qu.:1.6079  
[06.4_cropland_sensitivity.R]  Median :2.1114  
[06.4_cropland_sensitivity.R]  Mean   :2.1343  
[06.4_cropland_sensitivity.R]  3rd Qu.:2.6140  
...
[06.4_cropland_sensitivity.R]   GDAL Message 1: /tmp/RtmpGtvoWo/spat_2d914a875e87_11665_Py3ptIw2UFUXKtt.tif: Metadata exceeding 32000 bytes cannot be written into GeoTIFF. Transferred to PAM instead.
[06.4_cropland_sensitivity.R] Warning message:
[06.4_cropland_sensitivity.R] In e1@pntr$arith_rast(e2@pntr, oper, FALSE, opt) :
[06.4_cropland_sensitivity.R]   GDAL Message 1: /tmp/RtmpGtvoWo/spat_2d915240f69a_11665_8UwxxeZk3QEYL3o.tif: Metadata exceeding 32000 bytes cannot be written into GeoTIFF. Transferred to PAM instead.
[06.4_cropland_sensitivity.R] pdf 
[06.4_cropland_sensitivity.R]   2 
[06.4_cropland_sensitivity.R] pdf 
[06.4_cropland_sensitivity.R]   2 
...
[07.2_QRF_distribution_eval.R] pdf 
[07.2_QRF_distribution_eval.R]   2 
  ✓ PASS  07.2_QRF_distribution_eval.R                   ( 16.5s)  
...
[08.2_generate_virtual_farms.R]   (`?dplyr::dplyr_by`) instead.
[08.2_generate_virtual_farms.R] Error in `annotate()`:
[08.2_generate_virtual_farms.R] ! Problem while setting up geom aesthetics.
[08.2_generate_virtual_farms.R] ℹ Error occurred in the 5th layer.
[08.2_generate_virtual_farms.R] Caused by error in `list_sizes()`:
[08.2_generate_virtual_farms.R] ! `x$label` must be a vector, not a call.
[08.2_generate_virtual_farms.R] ℹ Read our FAQ about scalar types (`?vctrs::faq_error_scalar_type`) to learn more.
[08.2_generate_virtual_farms.R] Backtrace:
[08.2_generate_virtual_farms.R]      ▆
[08.2_generate_virtual_farms.R]   1. ├─base (local) `<fn>`(x)
[08.2_generate_virtual_farms.R]   2. ├─ggplot2 (local) `print.ggplot2::ggplot`(x)
[08.2_generate_virtual_farms.R]   3. │ ├─ggplot2::ggplot_build(x)
[08.2_generate_virtual_farms.R]   4. │ └─ggplot2 (local) `ggplot_build.ggplot2::ggplot`(x)
[08.2_generate_virtual_farms.R]   5. │   └─ggplot2:::by_layer(...)
[08.2_generate_virtual_farms.R]   6. │     ├─rlang::try_fetch(...)
[08.2_generate_virtual_farms.R]   7. │     │ ├─base::tryCatch(...)
[08.2_generate_virtual_farms.R]   8. │     │ │ └─base (local) tryCatchList(expr, classes, parentenv, handlers)
[08.2_generate_virtual_farms.R]   9. │     │ │   └─base (local) tryCatchOne(expr, names, parentenv, handlers[[1L]])
[08.2_generate_virtual_farms.R]  10. │     │ │     └─base (local) doTryCatch(return(expr), name, parentenv, handler)
[08.2_generate_virtual_farms.R]  11. │     │ └─base::withCallingHandlers(...)
[08.2_generate_virtual_farms.R]  12. │     └─ggplot2 (local) f(l = layers[[i]], d = data[[i]])
[08.2_generate_virtual_farms.R]  13. │       └─l$compute_geom_2(d, theme = plot@theme)
[08.2_generate_virtual_farms.R]  14. │         └─ggplot2 (local) compute_geom_2(..., self = self)
[08.2_generate_virtual_farms.R]  15. │           └─self$geom$use_defaults(...)
[08.2_generate_virtual_farms.R]  16. │             └─ggplot2 (local) use_defaults(..., self = self)
[08.2_generate_virtual_farms.R]  17. │               └─ggplot2:::check_aesthetics(new_params, nrow(data))
[08.2_generate_virtual_farms.R]  18. │                 └─vctrs::list_sizes(x)
[08.2_generate_virtual_farms.R]  19. └─vctrs:::stop_scalar_type(...)
[08.2_generate_virtual_farms.R]  20.   └─vctrs:::stop_vctrs(...)
[08.2_generate_virtual_farms.R]  21.     └─rlang::abort(message, class = c(class, "vctrs_error"), ..., call = call)
[08.2_generate_virtual_farms.R] Execution halted
  ✗ FAIL  08.2_generate_virtual_farms.R                  (  7.5s)  Exit code: 1
...
[08.3_farm_size_classes.R] Ncells 1960439 104.7    3708472 198.1  2846530 152.1
[08.3_farm_size_classes.R] Vcells 4002163  30.6    8388608  64.0  8378894  64.0
...
[08.3_farm_size_classes.R] Execution halted
  ✗ FAIL  08.3_farm_size_classes.R                       (  6.1s)  Exit code: 1
...
[10.1_prepare_validation_data.R] Execution halted
  ✗ FAIL  10.1_prepare_validation_data.R                 (  4.5s)  Exit code: 1
...
[10.2_external_validation.R] Execution halted
  ✗ FAIL  10.2_external_validation.R                     (  6.2s)  Exit code: 1
----------------------------------------------------------------------
...
[S02_cropland_uncertainty.R] CI: PDF write skipped (ImageMagick policy), PNG available
  ✓ PASS  S02_cropland_uncertainty.R                     ( 10.2s)  
...
[S03_aggregate_vs_disaggregate.R] Joining with `by = join_by(source)`
  ✓ PASS  S03_aggregate_vs_disaggregate.R                ( 31.2s)  
...
[S04_RF_hyperparameters.R]           1 
  ✓ PASS  S04_RF_hyperparameters.R                       (  7.4s)  
...
[S05_RF_unseen_performance.R] 6: Removed 2 rows containing missing values or values outside the scale range
[S05_RF_unseen_performance.R] (`geom_point()`). 
  ✓ PASS  S05_RF_unseen_performance.R                    (  4.7s)  
...
[S06_size_class_comparison.R] Joining with `by = join_by(test_country)`
  ✓ PASS  S06_size_class_comparison.R                    (  4.8s)  
...
[S08_variable_importance.R] CI: PDF write skipped (ImageMagick policy), PNG available
  ✓ PASS  S08_variable_importance.R                      (  7.9s)  
...
[T02_heterogeneity_drivers.R] Vcells 2996764 22.9    8388608  64.0  4971258  38.0
[T02_heterogeneity_drivers.R]           used (Mb) gc trigger  (Mb) max used  (Mb)
[T02_heterogeneity_drivers.R] Ncells 1806954 96.6    2846527 152.1  2846527 152.1
[T02_heterogeneity_drivers.R] Vcells 3126277 23.9    8388608  64.0  4971258  38.0
[T02_heterogeneity_drivers.R]           used (Mb) gc trigger  (Mb) max used  (Mb)
...
[T02_heterogeneity_drivers.R] Execution halted
  ✗ FAIL  T02_heterogeneity_drivers.R                    ( 11.3s)  Exit code: 1
...
======================================================================
  ...
  ✗ FAIL  03.2_correlation_drivers.R                       22.2    Exit code: 1
  ✓ PASS  03.3_descriptive_stats.R                         18.2    
  ✓ PASS  04.1_comparing_ML_algorithms.R                    1.2    
  ✓ PASS  04.2_RF_within_country.R                         41.9    
  ✓ PASS  04.3_RF_between_countries.R                       4.7    
  ✓ PASS  04.5_cross_country_graphs.R                       0.2    
  ✓ PASS  04.6_discrepancy_analysis.R                      13.0    
  ✓ PASS  05.1_RF_optimization.R                            3.3    
  ✓ PASS  05.3_RF_robustness.R                              0.2    
  ✓ PASS  06.1_quantile_RF.R                                2.9    
  ✓ PASS  06.3_prediction_maps.R                            5.0    
  ✓ PASS  06.4_cropland_sensitivity.R                      13.0    
  ✓ PASS  07.2_QRF_distribution_eval.R                     16.5    
  ✗ FAIL  08.2_generate_virtual_farms.R                     7.5    Exit code: 1
  ✗ FAIL  08.3_farm_size_classes.R                          6.1    Exit code: 1
  ✗ FAIL  09.1_AEZ_characterization.R                       3.7    Exit code: 1
  ✗ FAIL  10.1_prepare_validation_data.R                    4.5    Exit code: 1
  ✗ FAIL  10.2_external_validation.R                        6.2    Exit code: 1
  ✗ FAIL  F01_main_figure1.R                                3.6    Exit code: 1
  ✓ PASS  F02_main_figure2.R                                4.5    
  ✓ PASS  F03_main_figure3.R                                8.2    
  ✓ PASS  S01_drivers.R                                     1.2    
  ✓ PASS  S02_cropland_uncertainty.R                       10.2    
  ✓ PASS  S03_aggregate_vs_disaggregate.R                  31.2    
  ✓ PASS  S04_RF_hyperparameters.R                          7.4    
  ✓ PASS  S05_RF_unseen_performance.R                       4.7    
  ✓ PASS  S06_size_class_comparison.R                       4.8    
  ✓ PASS  S07_distribution_parameters.R                     4.8    
  ✓ PASS  S08_variable_importance.R                         7.9    
  ✓ PASS  T01_area_production_tables.R                      4.5    
  ✗ FAIL  T02_heterogeneity_drivers.R                      11.3    Exit code: 1

======================================================================
Total: 45   Passed: 37   Failed: 8   Time: 297s

Report: ../output/reports/full_pipeline_test_report.md

✅ CORE PIPELINE OK (16/22 core scripts passed = 73%)
```

## Pipeline Report
# Farm Size Prediction — Full Pipeline CI Report

**Generated:** 2026-03-16 23:41:22 UTC
...
| 01.3 | `01.3_chirps_trends.R` | ✅ PASS | 3.4s |  |
...
| 03.2 | `03.2_correlation_drivers.R` | ❌ FAIL | 22.2s | Exit code: 1 |
| 03.3 | `03.3_descriptive_stats.R` | ✅ PASS | 18.2s |  |
| 04.1 | `04.1_comparing_ML_algorithms.R` | ✅ PASS | 1.2s |  |
| 04.2 | `04.2_RF_within_country.R` | ✅ PASS | 41.9s |  |
| 04.3 | `04.3_RF_between_countries.R` | ✅ PASS | 4.7s |  |
| 04.5 | `04.5_cross_country_graphs.R` | ✅ PASS | 0.2s |  |
| 04.6 | `04.6_discrepancy_analysis.R` | ✅ PASS | 13s |  |
| 05.1 | `05.1_RF_optimization.R` | ✅ PASS | 3.3s |  |
| 05.3 | `05.3_RF_robustness.R` | ✅ PASS | 0.2s |  |
| 06.1 | `06.1_quantile_RF.R` | ✅ PASS | 2.9s |  |
| 06.3 | `06.3_prediction_maps.R` | ✅ PASS | 5s |  |
| 06.4 | `06.4_cropland_sensitivity.R` | ✅ PASS | 13s |  |
| 07.2 | `07.2_QRF_distribution_eval.R` | ✅ PASS | 16.5s |  |
| 08.2 | `08.2_generate_virtual_farms.R` | ❌ FAIL | 7.5s | Exit code: 1 |
| 08.3 | `08.3_farm_size_classes.R` | ❌ FAIL | 6.1s | Exit code: 1 |
| 09.1 | `09.1_AEZ_characterization.R` | ❌ FAIL | 3.7s | Exit code: 1 |
| 10.1 | `10.1_prepare_validation_data.R` | ❌ FAIL | 4.5s | Exit code: 1 |
| 10.2 | `10.2_external_validation.R` | ❌ FAIL | 6.2s | Exit code: 1 |
| F01 | `F01_main_figure1.R` | ❌ FAIL | 3.6s | Exit code: 1 |
| F02 | `F02_main_figure2.R` | ✅ PASS | 4.5s |  |
| F03 | `F03_main_figure3.R` | ✅ PASS | 8.2s |  |
| S01 | `S01_drivers.R` | ✅ PASS | 1.2s |  |
| S02 | `S02_cropland_uncertainty.R` | ✅ PASS | 10.2s |  |
| S03 | `S03_aggregate_vs_disaggregate.R` | ✅ PASS | 31.2s |  |
| S04 | `S04_RF_hyperparameters.R` | ✅ PASS | 7.4s |  |
| S05 | `S05_RF_unseen_performance.R` | ✅ PASS | 4.7s |  |
| S06 | `S06_size_class_comparison.R` | ✅ PASS | 4.8s |  |
| S07 | `S07_distribution_parameters.R` | ✅ PASS | 4.8s |  |
| S08 | `S08_variable_importance.R` | ✅ PASS | 7.9s |  |
| T01 | `T01_area_production_tables.R` | ✅ PASS | 4.5s |  |
| T02 | `T02_heterogeneity_drivers.R` | ❌ FAIL | 11.3s | Exit code: 1 |
