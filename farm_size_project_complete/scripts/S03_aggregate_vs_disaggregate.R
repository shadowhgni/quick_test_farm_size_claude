...
ggsave('../output/graphs/P00a1.png', P00a1, width = 9, height = 4.4, dpi = 150)
P00a2 <- magick::image_read('../output/graphs/P00a1.png')
...
ggsave('../output/graphs/P00b1.png', P00b1, width = 6, height = 4.4, dpi = 150)
P00b2 <- magick::image_read('../output/graphs/P00b1.png')
...
ggsave('../output/graphs/P00c.png', P00c, width = 3, height =  4.4, dpi = 150)
P00c2 <- magick::image_read('../output/graphs/P00c.png')

# Read two images
img1 <- magick::image_read('../output/graphs/P00a1.png')
img2 <- magick::image_read('../output/graphs/P00b1.png')
img3 <- magick::image_read('../output/graphs/P00c.png')
...
ggsave('../output/graphs/Suppl.Fig02.png', P00e , height = 9, width = 8.8, units = 'in', dpi = 150)
ggsave('../output/graphs/Suppl.Fig02.png', P00e , height = 9, width = 8.8, units = 'in', dpi = 300)
